...
function get_menu_list(datetogen) {
    function get_main(def_date, def_author) {
        const arr = [
            {
                link: "theory/",
                title: "Theory: German Language",
                desc: "Explore the fundamentals of the German language, including grammar, vocabulary, and pronunciation. This section provides a comprehensive overview of the key concepts and structures that form the basis of the German language. Click to access detailed lessons, interactive exercises, and resources to enhance your understanding of German.",
                codetype: "CSU2025 | German Language for Business",
                cardimage: "https://cdn.dmj.one/edu/su/course/csu2025/img/logo.webp",                
